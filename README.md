...
Open `http://localhost:3000` for the website and `http://localhost:3000/admin` for the CMS admin panel.
...
- `src/collections` — Payload collections and access rules
- `src/globals` — global site configuration
- `src/blocks` — reusable page-builder blocks
- `public` — static assets
- `tests` — automated tests
- `llms.txt` — concise project context for AI assistants and indexing tools
...
The sections below retain the upstream Payload Website Template documentation used by this project.
